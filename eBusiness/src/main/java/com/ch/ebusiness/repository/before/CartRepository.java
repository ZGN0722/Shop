...
public interface CartRepository {
	...
	public int updateWallet(@Param("uid") Integer uid, @Param("amount") double amount);
	...
	public int updateUpwd(@Param("uid") Integer uid, @Param("bpwd") String bpwd, @Param("user_name") String user_name, @Param("gender") Integer gender, @Param("mobile") String mobile, @Param("credit_card") String credit_card, @Param("email") String email);
