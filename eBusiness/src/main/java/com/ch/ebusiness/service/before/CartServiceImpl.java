...
public class CartServiceImpl implements CartService{
	...
	public String pay(Order order, HttpSession session) {
		...
		Integer uid = MyUtil.getUser(session).getId();
		double amount = cartRepository.getAmount(order.getId());
		cartRepository.updateWallet(uid, amount);
	...
	@Override
	public String updateUpwd(HttpSession session, String bpwd, String user_name, Integer gender, String mobile, String credit_card, String email) {
		Integer uid = MyUtil.getUser(session).getId();
		cartRepository.updateUpwd(uid, bpwd, user_name, gender, mobile, credit_card, email);
